...
"[project]/node_modules/wasmcurves/src/utils.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/wasmcurves/src/build_int.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/wasmcurves/src/build_timesscalar.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
*/ module.exports = function buildTimesScalar(module1, fnName, elementLen, opAB, opAA, opCopy, opInit) {
    ...
    function innerLoop() {
        const code = [];
        for(let i = 0; i < 8; i++){
            code.push(...c.call(opAA, c.getLocal("r"), c.getLocal("r")), ...c.if(c.i32_ge_u(c.getLocal("b"), c.i32_const(0x80 >> i)), [
...
"[project]/node_modules/wasmcurves/src/build_batchinverse.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: __turbopack_require_real__ } = __turbopack_context__;
{
module.exports = buildBatchInverse;
function buildBatchInverse(module1, prefix) {
    ...
    f.addCode(// aux[0] = a;
    c.call(prefix + "_one", c.getLocal("itAux")), // for (i=0;i<n;i++) aux[i] = aux[i-1]*in[i]
    c.setLocal("itIn", c.getLocal("pIn")), c.setLocal("itAux", c.i32_add(c.getLocal("itAux"), c.i32_const(n8))), c.setLocal("i", c.i32_const(0)), c.block(c.loop(c.br_if(1, c.i32_eq(c.getLocal("i"), c.getLocal("n"))), c.if(c.call(prefix + "_isZero", c.getLocal("itIn")), c.call(prefix + "_copy", c.i32_sub(c.getLocal("itAux"), c.i32_const(n8)), c.getLocal("itAux")), c.call(prefix + "_mul", c.getLocal("itIn"), c.i32_sub(c.getLocal("itAux"), c.i32_const(n8)), c.getLocal("itAux"))), c.setLocal("itIn", c.i32_add(c.getLocal("itIn"), c.getLocal("inStep"))), c.setLocal("itAux", c.i32_add(c.getLocal("itAux"), c.i32_const(n8))), c.setLocal("i", c.i32_add(c.getLocal("i"), c.i32_const(1))), c.br(0))), // point to the last
    c.setLocal("itIn", c.i32_sub(c.getLocal("itIn"), c.getLocal("inStep"))), c.setLocal("itAux", c.i32_sub(c.getLocal("itAux"), c.i32_const(n8))), // itOut = pOut + (n-1)*stepOut   // Point to the last
    c.setLocal("itOut", c.i32_add(c.getLocal("pOut"), c.i32_mul(c.i32_sub(c.getLocal("n"), c.i32_const(1)), c.getLocal("outStep")))), // aux[n-1] = 1/aux[n-1]
    c.call(prefix + "_inverse", c.getLocal("itAux"), c.getLocal("itAux")), c.block(c.loop(c.br_if(1, c.i32_eqz(c.getLocal("i"))), c.if(c.call(prefix + "_isZero", c.getLocal("itIn")), [
...
"[project]/node_modules/wasmcurves/src/build_batchconvertion.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: __turbopack_require_real__ } = __turbopack_context__;
{
module.exports = buildBatchConvertion;
function buildBatchConvertion(module1, fnName, internalFnName, sizeIn, sizeOut, reverse) {
...
"[project]/node_modules/wasmcurves/src/build_f1m.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
/*
    ...
    You should have received a copy of the GNU General Public License
    along with wasmsnark. If not, see <https://www.gnu.org/licenses/>.
*/ const buildInt = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_int.js [app-ssr] (ecmascript)");
const utils = __turbopack_require__("[project]/node_modules/wasmcurves/src/utils.js [app-ssr] (ecmascript)");
const buildExp = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_timesscalar.js [app-ssr] (ecmascript)");
const buildBatchInverse = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_batchinverse.js [app-ssr] (ecmascript)");
const buildBatchConvertion = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_batchconvertion.js [app-ssr] (ecmascript)");
const buildBatchOp = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_batchop.js [app-ssr] (ecmascript)");
const { bitLength, modInv, modPow, isPrime, isOdd, square } = __turbopack_require__("[project]/node_modules/wasmcurves/src/bigint.js [app-ssr] (ecmascript)");
module.exports = function buildF1m(module1, _q, _prefix, _intPrefix) {
    ...
    if (module1.modules[prefix]) return prefix; // already builded
    const intPrefix = buildInt(module1, n64, _intPrefix);
    const pq = module1.alloc(n8, utils.bigInt2BytesLE(q, n8));
    const pR2 = module1.alloc(utils.bigInt2BytesLE(square(1n << BigInt(n64 * 64)) % q, n8));
    const pOne = module1.alloc(utils.bigInt2BytesLE((1n << BigInt(n64 * 64)) % q, n8));
    const pZero = module1.alloc(utils.bigInt2BytesLE(0n, n8));
    const _minusOne = q - 1n;
    const _e = _minusOne >> 1n; // e = (p-1)/2
    const pe = module1.alloc(n8, utils.bigInt2BytesLE(_e, n8));
    const _ePlusOne = _e + 1n; // e = (p-1)/2
    const pePlusOne = module1.alloc(n8, utils.bigInt2BytesLE(_ePlusOne, n8));
    module1.modules[prefix] = {
        pq: pq,
        pR2: pR2,
        n64: n64,
    ...
    const pt = module1.alloc(n8, utils.bigInt2BytesLE(_t, n8));
    const _nqrToT = modPow(_nqr, _t, q);
    const pNqrToT = module1.alloc(utils.bigInt2BytesLE((_nqrToT << BigInt(n64 * 64)) % q, n8));
    const _tPlusOneOver2 = _t + 1n >> 1n;
    const ptPlusOneOver2 = module1.alloc(n8, utils.bigInt2BytesLE(_tPlusOneOver2, n8));
    function buildSqrt() {
    ...
    buildLoad();
    buildTimesScalar();
    buildBatchInverse(module1, prefix);
    buildBatchConvertion(module1, prefix + "_batchToMontgomery", prefix + "_toMontgomery", n8, n8);
    buildBatchConvertion(module1, prefix + "_batchFromMontgomery", prefix + "_fromMontgomery", n8, n8);
    buildBatchConvertion(module1, prefix + "_batchNeg", prefix + "_neg", n8, n8);
    buildBatchOp(module1, prefix + "_batchAdd", prefix + "_add", n8, n8);
    buildBatchOp(module1, prefix + "_batchSub", prefix + "_sub", n8, n8);
    buildBatchOp(module1, prefix + "_batchMul", prefix + "_mul", n8, n8);
    module1.exportFunction(prefix + "_add");
    module1.exportFunction(prefix + "_sub");
    ...
    buildExp(module1, prefix + "_exp", n8, prefix + "_mul", prefix + "_square", intPrefix + "_copy", prefix + "_one");
...
"[project]/node_modules/wasmcurves/src/build_f1.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
/*
    ...
    You should have received a copy of the GNU General Public License
    along with wasmsnark. If not, see <https://www.gnu.org/licenses/>.
*/ const buildF1m = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_f1m.js [app-ssr] (ecmascript)");
const { bitLength } = __turbopack_require__("[project]/node_modules/wasmcurves/src/bigint.js [app-ssr] (ecmascript)");
module.exports = function buildF1(module1, _q, _prefix, _f1mPrefix, _intPrefix) {
    ...
    const f1mPrefix = buildF1m(module1, q, _f1mPrefix, intPrefix);
...
"[project]/node_modules/wasmcurves/src/build_f2m.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
module.exports = function buildF2m(module1, mulNonResidueFn, prefix, f1mPrefix) {
    ...
    function buildSqrt() {
        ...
        const e34 = c.i32_const(module1.alloc(utils.bigInt2BytesLE((BigInt(q || 0) - 3n) / 4n, f1n8)));
        // BigInt can't take `undefined` so we use `|| 0`
        const e12 = c.i32_const(module1.alloc(utils.bigInt2BytesLE((BigInt(q || 0) - 1n) / 2n, f1n8)));
    ...
    module1.exportFunction(prefix + "_inverse");
    buildBatchInverse(module1, prefix);
    buildExp(module1, prefix + "_exp", f1n8 * 2, prefix + "_mul", prefix + "_square", prefix + "_copy", prefix + "_one");
    buildSqrt();
    buildIsSquare();
    module1.exportFunction(prefix + "_exp");
    module1.exportFunction(prefix + "_timesScalar");
...
"[project]/node_modules/wasmcurves/src/build_f3m.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
module.exports = function buildF3m(module1, mulNonResidueFn, prefix, f1mPrefix) {
    ...
    module1.exportFunction(prefix + "_inverse");
    buildBatchInverse(module1, prefix);
    buildExp(module1, prefix + "_exp", f1n8 * 3, prefix + "_mul", prefix + "_square", prefix + "_copy", prefix + "_one");
    module1.exportFunction(prefix + "_exp");
    module1.exportFunction(prefix + "_timesScalar");
    module1.exportFunction(prefix + "_batchInverse");
    module1.exportFunction(prefix + "_isNegative");
...
"[project]/node_modules/wasmcurves/src/build_timesscalarnaf.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/wasmcurves/src/build_multiexp.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/wasmcurves/src/build_curve_jacobian_a0.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
/*
    ...
    You should have received a copy of the GNU General Public License
    along with wasmsnark. If not, see <https://www.gnu.org/licenses/>.
*/ const buildTimesScalarNAF = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_timesscalarnaf.js [app-ssr] (ecmascript)");
//const buildTimesScalar = require("./build_timesscalar");
const buildBatchConvertion = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_batchconvertion.js [app-ssr] (ecmascript)");
const buildMultiexp = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_multiexp.js [app-ssr] (ecmascript)");
module.exports = function buildCurve(module1, prefix, prefixField, pB) {
    ...
    function buildToMontgomery() {
        ...
        for(let i = 1; i < 3; i++){
            f.addCode(c.call(prefixField + "_toMontgomery", c.i32_add(c.getLocal("p1"), c.i32_const(i * n8)), c.i32_add(c.getLocal("pr"), c.i32_const(i * n8))));
        }
    }
    ...
    function buildFromMontgomery() {
        ...
        for(let i = 1; i < 3; i++){
            f.addCode(c.call(prefixField + "_fromMontgomery", c.i32_add(c.getLocal("p1"), c.i32_const(i * n8)), c.i32_add(c.getLocal("pr"), c.i32_const(i * n8))));
        }
    }
    ...
    buildUtoLEM();
    buildCtoLEM();
    buildBatchConvertion(module1, prefix + "_batchLEMtoU", prefix + "_LEMtoU", n8 * 2, n8 * 2);
    buildBatchConvertion(module1, prefix + "_batchLEMtoC", prefix + "_LEMtoC", n8 * 2, n8);
    buildBatchConvertion(module1, prefix + "_batchUtoLEM", prefix + "_UtoLEM", n8 * 2, n8 * 2);
    buildBatchConvertion(module1, prefix + "_batchCtoLEM", prefix + "_CtoLEM", n8, n8 * 2, true);
    buildBatchConvertion(module1, prefix + "_batchToJacobian", prefix + "_toJacobian", n8 * 2, n8 * 3, true);
    buildMultiexp(module1, prefix, prefix + "_multiexp", prefix + "_add", n8 * 3);
    buildMultiexp(module1, prefix, prefix + "_multiexpAffine", prefix + "_addMixed", n8 * 2);
    /*
    buildTimesScalar(
        module,
    ...
    */ buildTimesScalarNAF(module1, prefix + "_timesScalar", n8 * 3, prefix + "_add", prefix + "_double", prefix + "_sub", prefix + "_copy", prefix + "_zero");
    buildTimesScalarNAF(module1, prefix + "_timesScalarAffine", n8 * 2, prefix + "_addMixed", prefix + "_double", prefix + "_subMixed", prefix + "_copyAffine", prefix + "_zero");
    module1.exportFunction(prefix + "_isZero");
...
"[project]/node_modules/wasmcurves/src/build_fft.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
/*
    ...
    You should have received a copy of the GNU General Public License
    along with wasmsnark. If not, see <https://www.gnu.org/licenses/>.
*/ const { isOdd, modInv, modPow } = __turbopack_require__("[project]/node_modules/wasmcurves/src/bigint.js [app-ssr] (ecmascript)");
const utils = __turbopack_require__("[project]/node_modules/wasmcurves/src/utils.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/wasmcurves/src/build_pol.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/wasmcurves/src/build_qap.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/wasmcurves/src/build_applykey.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/wasmcurves/src/bn128/build_bn128.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: __turbopack_require_real__ } = __turbopack_context__;
{
const utils = __turbopack_require__("[project]/node_modules/wasmcurves/src/utils.js [app-ssr] (ecmascript)");
const buildF1m = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_f1m.js [app-ssr] (ecmascript)");
const buildF1 = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_f1.js [app-ssr] (ecmascript)");
const buildF2m = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_f2m.js [app-ssr] (ecmascript)");
const buildF3m = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_f3m.js [app-ssr] (ecmascript)");
const buildCurve = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_curve_jacobian_a0.js [app-ssr] (ecmascript)");
const buildFFT = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_fft.js [app-ssr] (ecmascript)");
const buildPol = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_pol.js [app-ssr] (ecmascript)");
const buildQAP = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_qap.js [app-ssr] (ecmascript)");
const buildApplyKey = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_applykey.js [app-ssr] (ecmascript)");
const { bitLength, modInv, isOdd, isNegative } = __turbopack_require__("[project]/node_modules/wasmcurves/src/bigint.js [app-ssr] (ecmascript)");
module.exports = function buildBN128(module1, _prefix) {
    ...
    const pr = module1.alloc(utils.bigInt2BytesLE(r, frsize));
    const f1mPrefix = buildF1m(module1, q, "f1m");
    buildF1(module1, r, "fr", "frm");
    const pG1b = module1.alloc(utils.bigInt2BytesLE(toMontgomery(3n), f1size));
    const g1mPrefix = buildCurve(module1, "g1m", "f1m", pG1b);
    buildFFT(module1, "frm", "frm", "frm", "frm_mul");
    buildPol(module1, "pol", "frm");
    buildQAP(module1, "qap", "frm");
    const f2mPrefix = buildF2m(module1, "f1m_neg", "f2m", "f1m");
    ...
    const g2mPrefix = buildCurve(module1, "g2m", "f2m", pG2b);
    ...
    buildFFT(module1, "g1m", "g1m", "frm", "g1m_timesFr");
    buildGTimesFr("g2m_timesFr", "g2m_timesScalar");
    buildFFT(module1, "g2m", "g2m", "frm", "g2m_timesFr");
    buildGTimesFr("g1m_timesFrAffine", "g1m_timesScalarAffine");
    buildGTimesFr("g2m_timesFrAffine", "g2m_timesScalarAffine");
    buildApplyKey(module1, "frm_batchApplyKey", "fmr", "frm", n8, n8, n8, "frm_mul");
    buildApplyKey(module1, "g1m_batchApplyKey", "g1m", "frm", n8 * 3, n8 * 3, n8, "g1m_timesFr");
    buildApplyKey(module1, "g1m_batchApplyKeyMixed", "g1m", "frm", n8 * 2, n8 * 3, n8, "g1m_timesFrAffine");
    buildApplyKey(module1, "g2m_batchApplyKey", "g2m", "frm", n8 * 2 * 3, n8 * 3 * 2, n8, "g2m_timesFr");
    buildApplyKey(module1, "g2m_batchApplyKeyMixed", "g2m", "frm", n8 * 2 * 2, n8 * 3 * 2, n8, "g2m_timesFrAffine");
    ...
    build_mulNR6();
    const f6mPrefix = buildF3m(module1, prefix + "_mulNR6", "f6m", "f2m");
    ...
    build_mulNR12();
    const ftmPrefix = buildF2m(module1, prefix + "_mulNR12", "ftm", f6mPrefix);
    ...
    function buildFrobeniusMap(n) {
        ...
        for(let i = 0; i < 6; i++){
            ...
            if (n % 2 == 1) {
                f.addCode(c.call(f1mPrefix + "_copy", Xc0, Rc0), c.call(f1mPrefix + "_neg", Xc1, Rc1), c.call(f2mPrefix + "_mul", R, c.i32_const(pCoef), R));
            } else {
    ...
    function buildFinalExponentiationLastChunk() {
        ...
        c.call(prefix + "__cyclotomicExp_w0", elt, A), ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : c.call(ftmPrefix + "_conjugate", A, A), // B = A^2                // = elt^(-2*z)
        ...
        c.call(prefix + "__cyclotomicExp_w0", D, E), ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : c.call(ftmPrefix + "_conjugate", E, E), // F = E^2                // = elt^(12*z^2)
        c.call(prefix + "__cyclotomicSquare", E, F), // G = epx_by_neg_z(F)    // = elt^(-12*z^3)
        c.call(prefix + "__cyclotomicExp_w0", F, G), ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : c.call(ftmPrefix + "_conjugate", G, G), // H = conj(D)            // = elt^(6*z)
    ...
    function buildFinalExponentiationOld() {
        ...
        const pExponent = module1.alloc(utils.bigInt2BytesLE(exponent, 352));
        const c = f.getCodeBuilder();
...
"[project]/node_modules/wasmcurves/src/bls12381/build_bls12381.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
const buildQAP = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_qap.js [app-ssr] (ecmascript)");
const buildApplyKey = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_applykey.js [app-ssr] (ecmascript)");
const { bitLength, isOdd, isNegative } = __turbopack_require__("[project]/node_modules/wasmcurves/src/bigint.js [app-ssr] (ecmascript)");
...
module.exports = function buildBLS12381(module1, _prefix) {
    ...
    const frsize = n8r;
    const pr = module1.alloc(utils.bigInt2BytesLE(r, frsize));
    const f1mPrefix = buildF1m(module1, q, "f1m", "intq");
    buildF1(module1, r, "fr", "frm", "intr");
    const pG1b = module1.alloc(utils.bigInt2BytesLE(toMontgomery(4n), f1size));
    const g1mPrefix = buildCurve(module1, "g1m", "f1m", pG1b);
    buildFFT(module1, "frm", "frm", "frm", "frm_mul");
    buildPol(module1, "pol", "frm");
    buildQAP(module1, "qap", "frm");
    ...
    buildGTimesFr("g1m_timesFrAffine", "g1m_timesScalarAffine");
    buildGTimesFr("g2m_timesFrAffine", "g2m_timesScalarAffine");
    buildApplyKey(module1, "frm_batchApplyKey", "fmr", "frm", n8r, n8r, n8r, "frm_mul");
    buildApplyKey(module1, "g1m_batchApplyKey", "g1m", "frm", n8q * 3, n8q * 3, n8r, "g1m_timesFr");
    buildApplyKey(module1, "g1m_batchApplyKeyMixed", "g1m", "frm", n8q * 2, n8q * 3, n8r, "g1m_timesFrAffine");
    buildApplyKey(module1, "g2m_batchApplyKey", "g2m", "frm", n8q * 2 * 3, n8q * 3 * 2, n8r, "g2m_timesFr");
    buildApplyKey(module1, "g2m_batchApplyKeyMixed", "g2m", "frm", n8q * 2 * 2, n8q * 3 * 2, n8r, "g2m_timesFrAffine");
    function toMontgomery(a) {
        return BigInt(a) * (1n << BigInt(f1size * 8)) % q;
    }
    const G1gen = [
    ...
    build_mulNR2();
    const f6mPrefix = buildF3m(module1, f2mPrefix + "_mulNR", "f6m", "f2m");
    function build_mulNR6() {
    ...
    build_mulNR6();
    const ftmPrefix = buildF2m(module1, f6mPrefix + "_mulNR", "ftm", f6mPrefix);
    ...
    function buildCyclotomicExp(exponent, isExpNegative, fnName) {
        ...
        f.addCode(c.call(ftmPrefix + "_conjugate", x, inverse), c.call(ftmPrefix + "_one", res), c.if(c.teeLocal("bit", c.i32_load8_s(c.i32_const(exponentNafBytes.length - 1), pExponentNafBytes)), c.if(c.i32_eq(c.getLocal("bit"), c.i32_const(1)), c.call(ftmPrefix + "_mul", res, x, res), c.call(ftmPrefix + "_mul", res, inverse, res))), c.setLocal("i", c.i32_const(exponentNafBytes.length - 2)), c.block(c.loop(c.call(prefix + "__cyclotomicSquare", res, res), c.if(c.teeLocal("bit", c.i32_load8_s(c.getLocal("i"), pExponentNafBytes)), c.if(c.i32_eq(c.getLocal("bit"), c.i32_const(1)), c.call(ftmPrefix + "_mul", res, x, res), c.call(ftmPrefix + "_mul", res, inverse, res))), c.br_if(1, c.i32_eqz(c.getLocal("i"))), c.setLocal("i", c.i32_sub(c.getLocal("i"), c.i32_const(1))), c.br(0))));
        if (isExpNegative) {
            f.addCode(c.call(ftmPrefix + "_conjugate", res, res));
        }
    }
    function buildFinalExponentiation() {
        buildCyclotomicSquare();
    ...
    function buildFinalExponentiationOld() {
        ...
        const pExponent = module1.alloc(utils.bigInt2BytesLE(exponent, 544));
        const c = f.getCodeBuilder();
    ...
    function buildInGroupG2() {
        ...
        const frob2X = c.i32_const(module1.alloc(utils.bigInt2BytesLE(toMontgomery(FROB2X), n8q)));
        ...
        const z = c.i32_const(module1.alloc(utils.bigInt2BytesLE(finalExpZ, 8)));
    ...
    function buildInGroupG1() {
        ...
        const beta = c.i32_const(module1.alloc(utils.bigInt2BytesLE(toMontgomery(BETA), n8q)));
        const beta2 = c.i32_const(module1.alloc(utils.bigInt2BytesLE(toMontgomery(BETA2), n8q)));
        const z2m1d3 = c.i32_const(module1.alloc(utils.bigInt2BytesLE(Z2M1D3, 16)));
        const px = c.getLocal("p");
...
"[project]/node_modules/wasmcurves/index.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
module.exports.buildBn128 = __turbopack_require__("[project]/node_modules/wasmcurves/src/bn128/build_bn128.js [app-ssr] (ecmascript)");
module.exports.buildBls12381 = __turbopack_require__("[project]/node_modules/wasmcurves/src/bls12381/build_bls12381.js [app-ssr] (ecmascript)");
// module.exports.buildMnt6753 = require("./src/mnt6753/build_mnt7.js");
module.exports.buildF1m = __turbopack_require__("[project]/node_modules/wasmcurves/src/build_f1m.js [app-ssr] (ecmascript)");
}}),

};

//# sourceMappingURL=node_modules_wasmcurves_7301ba._.js.map