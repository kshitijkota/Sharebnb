...
function RetrieveData() {
    ...
    const generateProof = async (userId)=>{
        try {
            ...
            const { proof, publicSignals } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$snarkjs$2f$src$2f$groth16$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__groth16$3e$__["groth16"].fullProve(circuitInput, wasmFilePath, zkeyFilePath);
