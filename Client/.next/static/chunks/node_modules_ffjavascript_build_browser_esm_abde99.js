(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_ffjavascript_build_browser_esm_abde99.js", {

"[project]/node_modules/ffjavascript/build/browser.esm.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function rev(idx, bits) {
    return (_revTable$1[idx >>> 24] | _revTable$1[idx >>> 16 & 0xFF] << 8 | _revTable$1[idx >>> 8 & 0xFF] << 16 | _revTable$1[idx & 0xFF] << 24) >>> 32 - bits;
}
...
var build_f1m = function buildF1m(module, _q, _prefix, _intPrefix) {
    ...
    buildExp$2(module, prefix + "_exp", n8, prefix + "_mul", prefix + "_square", intPrefix + "_copy", prefix + "_one");
...
var build_f2m = function buildF2m(module, mulNonResidueFn, prefix, f1mPrefix) {
    ...
    buildExp$1(module, prefix + "_exp", f1n8 * 2, prefix + "_mul", prefix + "_square", prefix + "_copy", prefix + "_one");
    buildSqrt();
    buildIsSquare();
    module.exportFunction(prefix + "_exp");
    module.exportFunction(prefix + "_timesScalar");
...
var build_bn128 = function buildBN128(module, _prefix) {
    ...
    function buildFinalExponentiationLastChunk() {
        ...
        c.call(prefix + "__cyclotomicExp_w0", elt, A), c.call(ftmPrefix + "_conjugate", A, A), // B = A^2                // = elt^(-2*z)
        ...
        c.call(prefix + "__cyclotomicExp_w0", D, E), c.call(ftmPrefix + "_conjugate", E, E), // F = E^2                // = elt^(12*z^2)
        c.call(prefix + "__cyclotomicSquare", E, F), // G = epx_by_neg_z(F)    // = elt^(-12*z^3)
        c.call(prefix + "__cyclotomicExp_w0", F, G), c.call(ftmPrefix + "_conjugate", G, G), // H = conj(D)            // = elt^(6*z)
...
/* global BigInt */ function stringifyBigInts(o) {
...
/* global WebAssembly */ function thread(self) {
    const MAXMEM = 32767;
    let instance;
    let memory;
    if (self) {
...
//# sourceMappingURL=node_modules_ffjavascript_build_browser_esm_abde99.js.map